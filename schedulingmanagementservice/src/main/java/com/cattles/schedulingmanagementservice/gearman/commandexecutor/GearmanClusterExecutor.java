 ...
 */
public class GearmanClusterExecutor extends BaseCommandExecutor {
    private Logger logger = Logger.getLogger(GearmanClusterExecutor.class);

    private Session sshSession;
    private volatile static JSch jsch;

    private void initJsch() {
        synchronized (GearmanClusterExecutor.class) {
            if (jsch == null) {
                jsch = new JSch();
            }
        }
