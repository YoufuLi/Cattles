 ...
 */
public class IVMInformationMaintainImpl implements IVMInformationMaintainBiz {
    private static org.apache.log4j.Logger logger = Logger.getLogger(IVMInformationMaintainImpl.class);
